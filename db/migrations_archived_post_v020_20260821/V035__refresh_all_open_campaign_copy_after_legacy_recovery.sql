-- V035: refresh campaign copy for every still-open queue state, including
-- legacy pending/processing rows that V024 could not see before normalization.
-- This does not create recipients or relax eligibility; it only makes any
-- already-authorized open campaign use the current neutral/compliance template.
