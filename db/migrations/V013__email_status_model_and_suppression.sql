-- V013: modelagem de status de e-mail, suporte a NDR/reconciliação e suppression list.
...
comment on table email_suppressions is
  'Enderecos ou dominios suprimidos por hard bounce, opt-out operacional ou bloqueio definitivo de envio.';

comment on view vw_empresas_elegiveis is
  'Fonte fail-closed para campanhas: ativa, autorizada, sem opt-out/terceiro, sem suppression e sem envio ativo ou entregue no mesmo email normalizado.';
