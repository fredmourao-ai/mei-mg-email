...
Leia `docs/quality/AUDIT_MERGE_ENFORCEMENT_V1.md`. O governance-gate deve executar `scripts/absolute-audit-governance-validate.sh`; todo push em `main`/`master` deve passar pelo **Absolute Audit Main Guard** no runner autorizado.
